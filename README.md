...
| `POSTGRES_VERSION` | Bundled Postgres major version — pinned automatically on first start (18 for fresh installs, the existing volume's version otherwise). Must match the version your data volume was initialized with |
